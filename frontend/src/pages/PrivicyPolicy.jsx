    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-xl p-6">
          <h4 className="font-semibold text-lg text-green-300 mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-700 dark:text-gray-300 text-sm">
                Your data is stored in secure, encrypted databases with
                restricted access.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-slate-700 dark:text-gray-300 text-sm">
                Strict authentication and authorization protocols protect your
                account.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-slate-700 dark:text-gray-300 text-sm">
                We conduct regular security audits and updates to maintain
                protection.
              </p>
            </div>
          </div>
    ...
    content: (
      <div className="space-y-4">
        ...
        <p className="text-sm text-slate-500 dark:text-gray-400">
          ...
          that disabling certain cookies may impact site functionality.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          trusted third parties only in specific circumstances:
        </p>
        <div className="space-y-3">
          {[
            {
              ...
              description:
                'Payment processors (Razorpay), cloud storage (Cloudinary), and analytics tools that help us operate our platform.',
              color: 'blue',
            },
            {
              title: 'Legal Requirements',
              description:
                'When required by law, regulation, or legal process to protect our rights or comply with authorities.',
              color: 'yellow',
            },
            {
            ...
            >
              <h5 className={`font-semibold text-${item.color}-300 mb-2`}>
                {item.title}
              </h5>
              <p className="text-slate-700 dark:text-gray-300 text-sm">
                {item.description}
      ...
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {[
            ...
            <div
              key={i}
              className="bg-slate-100 dark:bg-gray-700/30 rounded-lg p-5 hover:bg-slate-200 dark:hover:bg-gray-700/50 transition-all duration-300"
            >
        ...
        <div className="bg-cyan-100 dark:bg-cyan-500/10 border border-cyan-300/60 dark:border-cyan-500/30 rounded-xl p-4 flex items-start gap-3">
          ...
          <p className="text-cyan-700 dark:text-cyan-200">
            ...
            <a
              ...
              className="font-semibold underline hover:text-cyan-300"
            >
