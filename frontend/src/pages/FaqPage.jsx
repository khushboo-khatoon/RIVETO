      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
            ...
            <p className="mt-4 text-lg text-slate-600 dark:text-gray-400 md:mt-5 md:text-xl">
              ...
              {faqs.map((item, index) => (
                <div key={index}>
                  <div className="flex max-w-sm flex-col items-center text-center">
                    ...
                    <dt className="mt-4 text-lg font-semibold text-slate-900 dark:text-white">
                      {item.question}
                    </dt>
                    <dd className="mt-2 text-base text-slate-700 dark:text-gray-300">
                      {item.answer}
                    </dd>
                  </div>
                </div>
          ...
          <div className="mt-12 flex flex-col items-center gap-6 rounded-2xl bg-white/85 dark:bg-gray-800/50 backdrop-blur-md border border-slate-200 dark:border-gray-700 px-6 py-8 text-center md:mt-16 md:gap-8 md:px-8 md:py-10">
            ...
            <div>
              ...
              <p className="mt-2 text-base md:text-lg text-slate-700 dark:text-gray-300">
