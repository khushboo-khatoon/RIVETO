...
const sections = [
    ...
    content: (
      <div className="space-y-4">
        <p className="text-lg">
          ...
          visit <span className="text-cyan-400 font-semibold">RIVETO</span>.
        ...
        <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-4">
          <p className="text-cyan-200">
            ...
            accordance with this Cookie Policy. You can manage your cookie
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          We use different types of cookies to ensure optimal performance and
          user experience:
        </p>
          ...
          {[
            {
              ...
              description:
                'Required for the website to function properly. These enable core functionality like security, authentication, and shopping cart.',
              color: 'green',
            },
            {
            ...
            },
            {
              ...
              description:
                'Remember your preferences and choices (like language, region, or theme) to provide enhanced features.',
              color: 'purple',
            },
            {
              title: 'Targeting/Advertising Cookies',
              description:
                'Track your browsing habits to deliver relevant ads and measure campaign effectiveness.',
              color: 'pink',
            },
          ].map((item, i) => (
            <div
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4
                    className={`font-semibold text-lg text-${item.color}-300 mb-2`}
                  >
                    {item.title}
                  </h4>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Cookies help us improve your shopping experience and website
          performance:
        </p>
        <div className="grid md:grid-cols-2 gap-4">
          {[
            ...
            <div
              key={i}
              className="flex items-start gap-3 bg-gray-700/30 p-4 rounded-lg hover:bg-gray-700/50 transition-all duration-300"
            >
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          We may use third-party services that set cookies on our website to
        ...
        <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/30 rounded-xl p-6">
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-center gap-2">
              <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
              <span>
                <strong>Payment Processors:</strong> Stripe, PayPal, and
            ...
            <li className="flex items-center gap-2">
              <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
              <span>
                <strong>Social Media:</strong> Facebook, Twitter, Instagram
                integration
              </span>
            </li>
            <li className="flex items-center gap-2">
              <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
              <span>
                <strong>Advertising Networks:</strong> Google Ads and other ad
                platforms
              </span>
            </li>
          </ul>
        ...
        <p className="text-sm text-gray-400">
          Please note that we do not control these third-party cookies. We
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-xl p-6">
          <h4 className="font-semibold text-lg text-cyan-300 mb-4">
            Browser Settings
          </h4>
          <p className="mb-4">
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 flex gap-3">
          ...
          <div>
            ...
            <p className="text-gray-300">
              ...
              function properly. You may experience limited functionality,
              especially with the shopping cart and checkout process.
            </p>
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          You have several options to control how cookies are used on your
          device:
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-gray-700/30 p-5 rounded-xl border border-gray-600">
            ...
            <p className="text-sm text-gray-300">
              Allow all cookies for the best user experience, including
          ...
          <div className="bg-gray-700/30 p-5 rounded-xl border border-gray-600">
            ...
            <p className="text-sm text-gray-300">
              Choose which types of cookies you want to accept. Essential
          ...
          <div className="bg-gray-700/30 p-5 rounded-xl border border-gray-600">
            ...
            <p className="text-sm text-gray-300">
              Only allow essential cookies needed for basic website
              functionality. This may limit features.
            </p>
          </div>
          ...
          <div className="bg-gray-700/30 p-5 rounded-xl border border-gray-600">
            ...
            <p className="text-sm text-gray-300">
              Enable "Do Not Track" in your browser settings to signal your
              privacy preferences.
            </p>
          </div>
        </div>
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          in technology, legislation, or our practices.
        </p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              <span className="text-cyan-400 font-semibold">RIVETO</span>
            </p>
