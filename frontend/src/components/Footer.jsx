...
function Footer() {
  ...
  const handleSubscribe = () => {
    ...
    setTimeout(() => {
      ...
      toast.success(
        '🎁 You’ve successfully subscribed to Riveto! Enjoy exclusive offers.'
      );
      ...
      <div className="max-w-7xl mx-auto py-16 px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 relative z-10">
        ...
        <div className="footer-section">
          ...
          <p className="text-sm leading-relaxed text-gray-500 dark:text-gray-400 mb-6 font-medium">
            RIVETO is a premium e-commerce platform built for the modern
            shopper. Experience seamless shopping with cutting-edge technology
          ...
          <div className="flex gap-3">
            {[
              ...
              <button
                ...
                type="button"
                onClick={() =>
                  toast.info(`Follow us on ${social.name} - Coming soon!`)
                }
      ...
      <div className="bg-gradient-to-r from-slate-100 to-slate-200 dark:from-gray-900 dark:to-gray-950 py-6 border-t border-slate-300 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600 dark:text-gray-500 text-center md:text-left">
            © {currentYear}{' '}
            <span className="text-cyan-400 font-medium">RIVETO</span> — All
            rights reserved.
          </p>
